...
const techs = [
  ...
  { name: "Bash", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/bash/bash-original.svg", darkInvert: true },
        ...
        return (
          ...
          >
            <FallbackImage
              ...
              height={28}
              title={tech.name}
              className={tech.darkInvert ? "dark:brightness-0 dark:invert" : ""}
            />
          </div>
        );
      })}
